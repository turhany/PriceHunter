...
using PriceHunter.Common.Swagger;

namespace PriceHunter.Api.Configurations.Swagger
{
    /// <summary>
    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>, IConfigureOptions<SwaggerUIOptions>
    {
        ...
        private static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            var info = new OpenApiInfo
            {
                ...
                Description = "PriceHunter Web API",
                Contact = new OpenApiContact { Name = "PriceHunter Support Team", Email = SwaggerConstants.SupportEmailAddress },
                // License = new OpenApiLicense { Name = "PriceHunter End User License", Url = new Uri(SwaggerConstants.HeadContent) },
